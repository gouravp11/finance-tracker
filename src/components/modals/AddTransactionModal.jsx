    ...
    return (
        <div className="relative" ref={ref}>
            ...
            >
                ...
                <svg
                    className="ml-2 h-4 w-4 text-gray-500 dark:text-slate-400"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                    aria-hidden="true"
                >
                ...
                <ul className="absolute left-0 right-0 mt-1 z-20 bg-white dark:bg-slate-700 border dark:border-slate-600 rounded shadow max-h-48 overflow-auto">
                    {options.map((opt) => (
                        <li
                            ...
                            className="px-3 py-2 hover:bg-gray-100 dark:hover:bg-slate-600 cursor-pointer text-gray-900 dark:text-white"
                        >
                            {opt}
                        </li>
                    ))}
